...
function themeChanger() {
    if(theme == "dark") {
        ...
        propertySetter("--timer-card-background", "linear-gradient(127.07deg, rgba(91, 91, 91, 0.75) 0%, rgba(92, 92, 92, 0.15) 100.01%)")
    ...
    else
    {
        ...
        propertySetter("--timer-card-background", "linear-gradient(127.07deg, rgba(255, 255, 255, 0.5) 0%, rgba(222, 162, 183, 0.8) 100.01%)")
